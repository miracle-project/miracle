...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Miracle " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"165.227.184.204", "165.227.184.204"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"miracletools.com", "testnet-seed.miracletools.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Miracle is probably already running."), addrBind.ToString().c_str());
        else
